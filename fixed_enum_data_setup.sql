-- =============================================================================
-- FIXED ENUM DATA SETUP - USING ONLY VALID ENUM VALUES
-- =============================================================================
...
-- =============================================================================
-- 5. CASES - Using only valid enum values (open, closed, rejected)
-- =============================================================================
-- Using the most common valid enum values: open, closed, rejected
INSERT INTO cases (id, organization_id, customer_id, product_id, status, created_at, updated_at)
VALUES 
-- Cases for Approval Queue - using 'open' status
(1, 1, 1, 1, 'open', NOW() - INTERVAL '2 hours', NOW()),
(2, 1, 2, 3, 'open', NOW() - INTERVAL '4 hours', NOW()),
(3, 1, 3, 2, 'open', NOW() - INTERVAL '1 hour', NOW()),
(4, 1, 4, 1, 'open', NOW() - INTERVAL '3 hours', NOW()),
(5, 1, 5, 3, 'open', NOW() - INTERVAL '5 hours', NOW()),

-- Cases for Compliance Review - using 'open' status (will be filtered by other criteria)
(6, 1, 1, 2, 'open', NOW() - INTERVAL '6 hours', NOW()),
(7, 1, 2, 1, 'open', NOW() - INTERVAL '8 hours', NOW()),

-- Approved and Rejected cases
(8, 1, 3, 2, 'closed', NOW() - INTERVAL '1 day', NOW() - INTERVAL '2 hours'),
(9, 1, 4, 1, 'closed', NOW() - INTERVAL '2 days', NOW() - INTERVAL '1 day'),
...
-- Show cases for Approval Queue (using 'open' status)
