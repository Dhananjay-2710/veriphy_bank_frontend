-- =============================================================================
-- FINAL CORRECTED DATA SETUP - USING EXACT ENUM VALUES
-- =============================================================================
-- This script uses the exact enum values from your database
-- =============================================================================
...
-- =============================================================================
-- 5. CASES - Using valid case_status and case_priority values
-- =============================================================================
INSERT INTO cases (id, organization_id, customer_id, product_id, status, priority, created_at, updated_at)
VALUES 
-- Cases for Approval Queue - using 'open' and 'in_progress' status
(1, 1, 1, 1, 'open', 'high', NOW() - INTERVAL '2 hours', NOW()),
(2, 1, 2, 3, 'in_progress', 'medium', NOW() - INTERVAL '4 hours', NOW()),
(3, 1, 3, 2, 'open', 'high', NOW() - INTERVAL '1 hour', NOW()),
(4, 1, 4, 1, 'open', 'low', NOW() - INTERVAL '3 hours', NOW()),
(5, 1, 5, 3, 'in_progress', 'medium', NOW() - INTERVAL '5 hours', NOW()),

-- Cases for Compliance Review - using 'open' status (will be filtered by other criteria)
(6, 1, 1, 2, 'open', 'high', NOW() - INTERVAL '6 hours', NOW()),
(7, 1, 2, 1, 'open', 'medium', NOW() - INTERVAL '8 hours', NOW()),

-- Approved and Rejected cases
(8, 1, 3, 2, 'closed', 'low', NOW() - INTERVAL '1 day', NOW() - INTERVAL '2 hours'),
(9, 1, 4, 1, 'closed', 'medium', NOW() - INTERVAL '2 days', NOW() - INTERVAL '1 day'),
(10, 1, 5, 3, 'rejected', 'high', NOW() - INTERVAL '3 days', NOW() - INTERVAL '2 days')
ON CONFLICT (id) DO NOTHING;
...
-- =============================================================================
-- 7. TASKS - Using valid task_status and task_priority values
-- =============================================================================
INSERT INTO tasks (id, organization_id, title, status, priority, created_at, updated_at)
VALUES 
(1, 1, 'Review Ramesh Gupta Application', 'open', 'high', NOW() - INTERVAL '1 hour', NOW()),
(2, 1, 'Verify Deepak Agarwal Documents', 'in_progress', 'medium', NOW() - INTERVAL '2 hours', NOW()),
(3, 1, 'Process Rohit Sharma Loan', 'completed', 'high', NOW() - INTERVAL '3 hours', NOW()),
(4, 1, 'Check Kavya Menon KYC', 'open', 'low', NOW() - INTERVAL '4 hours', NOW()),
(5, 1, 'Follow up Sanjay Patel', 'overdue', 'high', NOW() - INTERVAL '5 hours', NOW())
ON CONFLICT (id) DO NOTHING;

-- =============================================================================
-- 8. UPDATE EXISTING USER (Meera Joshi) - Set correct role and organization
-- =============================================================================
UPDATE users 
SET 
  role = 'credit-ops',
...
-- =============================================================================
-- END OF FINAL CORRECTED DATA SETUP
-- =============================================================================
